...
def crawl_url(driver: Webdriver,
    ...
    element_to_click = driver.find_element(By.CSS_SELECTOR,".xzg4506.xycxndf.xua58t2.x4xrfw5.x1lq5wgf")

    # # # Approach 1: Scroll to the element
    # driver.execute_script("arguments[0].scrollIntoView();", element_to_click)

    # # Approach 2: Click using JavaScript
