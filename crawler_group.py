...
"""//"https://www.facebook.com/groups/chuaieltswritingvaluyenspeakingmienphi/media/photos"""
import selenium
...
def crawl_url(driver: Webdriver,
    ...
    first_photo = driver.find_element(By.CSS_SELECTOR, ".x1rg5ohu.x5yr21d.xl1xv1r.xh8yej3")

    first_photo.click()

    time.sleep(3)
    for i in range(post_limit):
        i_element = driver.find_element(By.CSS_SELECTOR, "img.x1bwycvy.x193iq5w.x4fas0m.x19kjcj4")
        ...
        matching_elements = driver.find_elements(By.CSS_SELECTOR, ".x14yjl9h.xudhj91.x18nykt9.xww2gxu.x6s0dn4.x972fbf.xcfux6l.x1qhh985.xm0m39n.x9f619.x3nfvp2.xl56j7k.x1n2onr6.x1qhmfi1.xsdox4t.x1useyqa")
